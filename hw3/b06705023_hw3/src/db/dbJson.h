...
public:
  ...
  //This is to used as an explicit bool object operation.
  // This function will be involked whenever there is a:
  // If(DBjson)
  explicit operator bool() const { return this->initialized; }
  
  //Initially, it is set to false to represent nothing has been read in.
  //After involking operator >>, this will then be set to TRUE for long.
